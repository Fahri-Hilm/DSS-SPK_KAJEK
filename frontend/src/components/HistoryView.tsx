...
import { Trash2, RotateCcw, FileDown, Search, Filter, Calendar, Tag, ArrowRight, CheckCircle2, MoreVertical, X, Sparkles, Scale, TrendingUp, Award, History, Clock } from 'lucide-react';
